...
public class QBase32 {
  ...
  private static final int[] base32Lookup = { 0xFF, 0xFF, 0x1A, 0x1B, 0x1C,
      ...
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // '8', '9', ':', ';',
                                                      // '<', '=', '>', '?'
      0xFF, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, // '@', 'A', 'B', 'C',
                                                      // 'D', 'E', 'F', 'G'
      0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, // 'H', 'I', 'J', 'K',
                                                      // 'L', 'M', 'N', 'O'
      0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, // 'P', 'Q', 'R', 'S',
                                                      // 'T', 'U', 'V', 'W'
  ...
  static public byte[] encode(final byte[] bytes) {
    ...
    // according to RFC 3548, the encoding must also contain paddings in some
    // cases
    int add = 0;
    switch (bytes.length) {
    case 1:
  ...
  static public String decode(final String base32) {
    ...
    for (int i1 = 0; i1 < bytes.length; i1++) {
      ...
      rv += (Integer.toHexString(b + 256)).substring(1);
    }
    return rv;
  }
  ...
  static public void main(String[] args) {
    ...
    // byte[] decoded = QBase32.decode(args[0]);
    ...
    // }
    // System.out.println();
    // System.out.println("Reencoded: " + QBase32.encode(decoded));
  }
}